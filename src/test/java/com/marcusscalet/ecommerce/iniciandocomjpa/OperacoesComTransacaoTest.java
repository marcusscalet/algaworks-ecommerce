...
public class OperacoesComTransacaoTest extends EntityManagerTest {
    ...
    public void mostrarDiferençaPersistMerge() {
        ...
        produtoPersist.setNome("Smartphone One Plus Rode Videmic");
        ...
        produtoMerge.setNome("Nootebok Dell");
    ...
    public void atualizarObjetoGerenciado() {
        ...
        //executar clear para que o find abaixo busque o objeto direto do banco ao invés do gerenciado pela memória
        entityManager.clear();

        Produto produtoVerificado = entityManager.find(Produto.class, produto.getId());
        Assert.assertEquals("Kindle Paperwhite 2ª Geração", produtoVerificado.getNome());
    }
